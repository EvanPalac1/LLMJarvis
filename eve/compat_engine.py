...
# Los presets viven en `proveedores.py`, que no importa nada: leerlos desde
# aca arrastraba el motor entero y costaba cinco segundos al abrir el panel.
from .proveedores import GRATIS, PROVEEDORES  # noqa: F401
